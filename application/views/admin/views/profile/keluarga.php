    ...
    <div class="col-md-12">
      <div class="box box-body">
        ...
        <div class="col-md-6 text-right">
          <a href="<?= base_url('admin/profile/tambah_keluarga?id=anak'); ?>" class="btn btn-success"><i class="fa fa-list"></i> Tambah Anak</a> <a href="<?= base_url('admin/profile/tambah_keluarga?id=pasutri'); ?>" class="btn btn-success"><i class="fa fa-list"></i> Tambah Pasutri</a>
        </div>
            ...
            <tbody>
              ...
              <!--  <td style="text-align: center"><?php 
                 ...
                 <td style="text-align:center;">
                  <a title="Edit" class="update btn btn-sm btn-success" href="<?php echo base_url('admin/profile/edit_'. $keluarga['status_keluarga'].'/' . $keluarga['id']); ?>"> <i class="fa fa-pencil-square-o"></i></a>
