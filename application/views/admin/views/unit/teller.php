...
<hr>
<?php echo form_open_multipart(base_url('admin/unit/add_teller/'.$current_kantor ."/" . $current_unit."/din"), 'class="form-horizontal"' )?> 
...
<h4>Kecepatan dan Ketepatan kerja (hasil Evaluasi oleh Nasabah)</h4>
<hr>
<?php echo form_open_multipart(base_url('admin/unit/add_teller/'.$current_kantor ."/" . $current_unit."/din"), 'class="form-horizontal"' )?> 
    
    <input name="maqasid" type="hidden" value="nafs">
    <input name="sub_maqasid" type="hidden" value="kecepatan">
  ...
  <!--  <div class="form-group">
    ...
    <div class="form-group">
      <label for="nama_pemateri" class="col-sm-3 control-label">Upload hasil evaluasi pelanggan terhadap teller</label>
      <div class="col-sm-6">
        <input type="file" name="file_kecepatan_kerja" value="" class="form-control" id="nama_pemateri" placeholder="">
      </div>
    </div>         
