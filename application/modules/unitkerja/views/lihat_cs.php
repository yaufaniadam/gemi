...
<ul class="nav nav-tabs">
  ...
  <li role="presentation" <?php if($sub_maqasid == 'mitra_baru') { echo 'class="active"'; } ?>><a href="<?php echo base_url("unitkerja/index/mitra_baru" ); ?>">
  <h4>Hifdz An-Nafs</h4><p>Penambahan mitra baru</p></a></li>

  <li role="presentation" <?php if($sub_maqasid == 'evaluasi_nasabah') { echo 'class="active"'; } ?>><a href="<?php echo base_url("unitkerja/index/evaluasi_nasabah" ); ?>">
