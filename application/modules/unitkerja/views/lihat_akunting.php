...
<ul class="nav nav-tabs">
  ...
  <li role="presentation" <?php if($sub_maqasid == 'laporan_keuangan') { echo 'class="active"'; } ?>><a href="<?php echo base_url("unitkerja/index/laporan_keuangan" ); ?>">
    <h4>Hifdz Al-Maal</h4><p>Laporan keuangan Akhir Bulan</p></a></li>

  <li role="presentation" <?php if($sub_maqasid == 'laporan_keuangan_harian') { echo 'class="active"'; } ?>><a href="<?php echo base_url("unitkerja/index/laporan_keuangan_harian" ); ?>">
