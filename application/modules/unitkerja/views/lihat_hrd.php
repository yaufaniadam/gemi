<?php 
  ...
  $url_sub_maqasid= $this->uri->segment($last);
?>
<ul class="nav nav-tabs">
  <li role="presentation" <?php if($url_sub_maqasid == 'pengajian') { echo 'class="active"'; } ?>><a href="<?php echo base_url("unitkerja/index/pengajian" ); ?>">
    <h4>Hifdz Ad-Din</h4><p>Pengajian</p></a></li>
  <li role="presentation" <?php if($url_sub_maqasid == 'rekrutmen') { echo 'class="active"'; } ?>><a href="<?php echo base_url("unitkerja/index/rekrutmen" ); ?>">
  <h4>Hifdz An-Nafs</h4><p>Rekrutmen</p></a></li>
  <li role="presentation" <?php if($url_sub_maqasid == 'kinerja') { echo 'class="active"'; } ?>><a href="<?php echo base_url("unitkerja/index/kinerja" ); ?>">
  <h4>Hifdz An-Nafs</h4><p>Manajemen kinerja</p></a></li>
  <li role="presentation" <?php if($url_sub_maqasid == 'employee_productivity') { echo 'class="active"'; } ?>><a href="<?php echo base_url("unitkerja/index/employee_productivity" ); ?>">
  <h4>Hifdz An-Nafs</h4><p>Employee productivity</p></a></li>

  <li role="presentation" <?php if($url_sub_maqasid == 'training') { echo 'class="active"'; } ?>><a href="<?php echo base_url("unitkerja/index/training" ); ?>">
    <h4>Hifdz Al’Aql</h4><p>Training</p></a></li>

  <li role="presentation" <?php if($url_sub_maqasid == 'gathering') { echo 'class="active"'; } ?>><a href="<?php echo base_url("unitkerja/index/gathering" ); ?>">
  <h4>Hifdz An-Nasl</h4><p>Gathering</p></a></li>

  <li role="presentation" <?php if($url_sub_maqasid == 'gaji') { echo 'class="active"'; } ?>><a href="<?php echo base_url("unitkerja/index/gaji" ); ?>">
...
<table class="table table-striped table-bordered">
  ...
  <tr>
    ...
    <td><a target="_blank" href="<?=base_url($unit['file_presensi']); ?>" class="btn btn-success btn-xs"><i class="fa fa-download"></i></a></td>
    <td><a target="_blank" href="<?=base_url($unit['file_komentar']); ?>" class="btn btn-success btn-xs"><i class="fa fa-download"></i></a></td>
    <td><a target="_blank" href="<?=$unit['link_berita']; ?>" class="btn btn-success btn-xs"><i class="fa fa-link"></i></a></td>
    <td><?=$unit['rekomendasi']; ?></td>
