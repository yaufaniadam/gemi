...
<ul class="nav nav-tabs">
  ...
  <li role="presentation" <?php if ($sub_maqasid == 'review_kerja') {
                            echo 'class="active"';
                          } ?>><a href="<?php echo base_url("unitkerja/index/review_kerja"); ?>">
      <h4>Hifdz Al-Maal</h4>
      <p>Review efisiensi dan efektivitas kerja</p>
    </a></li>

  <li role="presentation" <?php if ($sub_maqasid == 'review_keuangan') {
                            echo 'class="active"';
                          } ?>><a href="<?php echo base_url("unitkerja/index/review_keuangan"); ?>">
      <h4>Hifdz Al-Maal</h4>
      <p>Review laporan keuangan</p>
    </a></li>

  <li role="presentation" <?php if ($sub_maqasid == 'review_rencana') {
                            echo 'class="active"';
                          } ?>><a href="<?php echo base_url("unitkerja/index/review_rencana"); ?>">
      <h4>Hifdz Al-Maal</h4>
      <p>Review dan monitoring Rencana Tindak Lanjut Unit Kerja</p>
    </a></li>
