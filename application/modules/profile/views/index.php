		...
		<div class="col-md-9">
			...
			<div class="box box-body">
				...
				<select id="select_menu" class="form-control">
					...
					<option value="<?= base_url('kinerja/individu/detail_din/' . $user['id']) ?>" class="btn btn-default btn-md">Hifdz An Nafs / Penjagaan Jiwa</option>
					<option value="<?= base_url('kinerja/individu/detail_din/' . $user['id']) ?>" class="btn btn-default btn-md">Hifdz Al 'Aql' / Penjagaan Pikiran</option>
					<option value="<?= base_url('kinerja/individu/detail_din/' . $user['id']) ?>" class="btn btn-default btn-md">Hifdz An Nasl / Penjagaan Keturunan</option>
					<option value="<?= base_url('kinerja/individu/detail_din/' . $user['id']) ?>" class="btn btn-default btn-md">Hifdz Al Mal / Penjagaan Harta</option>
				</select>
			</div>
		</div>
		<!-- /.col -->
