  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-body">
        <div class="col-md-6">
          <h4><i class="fa fa-pencil"></i> &nbsp; Edit Anggota Keluarga</h4>
        </div>
    ...
    <div class="col-md-12">
      <div class="box">
        ...
        <div class="box-body m-form-body">
            ...
            <?php endif; ?>
            <?php echo form_open(base_url('profile/edit_keluarga/'.$keluarga['id']), 'class="form-horizontal"' )?> 
              ...
              <div class="form-group">
                <label for="status_keluarga" class="col-sm-2 control-label">Status Dalam Keluarga</label>              
                <div class="col-sm-3">                  
                    <select name="status_keluarga" class="form-control" id="status_keluarga" >
                      <option value="" <?php echo set_select('status_keluarga', '',TRUE); ?>>Pilih Status Keluarga</option>  
                      <option value="Suami" <?php if(validation_errors()) { echo set_select('status_keluarga', 'Suami'); } else { if($keluarga['status_keluarga']=='Suami'){ echo "selected"; } } ?>>Suami</option>
                      <option value="Istri" <?php if(validation_errors()) { echo set_select('status_keluarga', 'Istri'); } else { if($keluarga['status_keluarga']=='Istri'){ echo "selected"; } } ?>>Istri</option>
                      <option value="Anak" <?php if(validation_errors()) { echo set_select('status_keluarga', 'Anak'); } else { if($keluarga['status_keluarga']=='Anak'){ echo "selected"; } } ?>>Anak</option>                          
                    </select>                      
                </div>
