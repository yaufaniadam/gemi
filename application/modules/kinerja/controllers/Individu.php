...
class Individu extends MY_Controller
{
	...
	public function din($id = 0, $tahun = 0)
	{
	...
	{
		if ($this->input->post('submit')) {
			//$this->form_validation->set_rules('saving', 'Jumlah saving', 'trim|required');
		//	$this->form_validation->set_rules('hutang', 'Jumlah Hutang', 'trim|required');
			//$this->form_validation->set_rules('tempat_hutang', 'Lembaga tempat berhutang', 'trim|required');
