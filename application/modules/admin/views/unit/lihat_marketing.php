...
<ul class="nav nav-tabs">
  ...
  <li role="presentation" <?php if ($sub_maqasid == 'funding') {
                            echo 'class="active"';
                          } ?>><a href="<?php echo base_url('admin/unit/lihat_unit/' . $current_kantor . "/" . $current_unit . "/funding"); ?>">
      <h4>Hifdz Al-Maal</h4>
      <p>Funding</p>
    </a></li>

  <li role="presentation" <?php if ($sub_maqasid == 'lending') {
                            echo 'class="active"';
                          } ?>><a href="<?php echo base_url('admin/unit/lihat_unit/' . $current_kantor . "/" . $current_unit . "/lending"); ?>">
      <h4>Hifdz Al-Maal</h4>
      <p>Lending</p>
    </a></li>

  <li role="presentation" <?php if ($sub_maqasid == 'collection') {
                            echo 'class="active"';
                          } ?>><a href="<?php echo base_url('admin/unit/lihat_unit/' . $current_kantor . "/" . $current_unit . "/collection"); ?>">
      <h4>Hifdz Al-Maal</h4>
      <p>Collection</p>
    </a></li>

  <li role="presentation" <?php if ($sub_maqasid == 'npf') {
                            echo 'class="active"';
                          } ?>><a href="<?php echo base_url('admin/unit/lihat_unit/' . $current_kantor . "/" . $current_unit . "/npf"); ?>">
      <h4>Hifdz Al-Maal</h4>
      <p>NPF</p>
    </a></li>
