...
<ul class="nav nav-tabs">
  ...
  <li role="presentation" <?php if ($sub_maqasid == 'mitra_baru') {
                            echo 'class="active"';
                          } ?>><a href="<?php echo base_url('admin/unit/lihat_unit/' . $current_kantor . "/" . $current_unit . "/mitra_baru"); ?>">
      <h4>Hifdz An-Nafs</h4>
      <p>Penambahan mitra baru</p>
    </a></li>

  <li role="presentation" <?php if ($sub_maqasid == 'evaluasi_nasabah') {
                            echo 'class="active"';
                          } ?>><a href="<?php echo base_url('admin/unit/lihat_unit/' . $current_kantor . "/" . $current_unit . "/evaluasi_nasabah"); ?>">
      <h4>Hifdz An-Nafs</h4>
      <p>Keramahan</p>
    </a></li>
