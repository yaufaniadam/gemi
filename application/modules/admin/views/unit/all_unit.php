  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-body">
        <div class="col-md-6">
          <h4><i class="fa fa-gears"></i> &nbsp; Unit Kerja</h4>
        </div>
        <div class="col-md-6 text-right">
          <a data-toggle="modal" data-target="#add_unit" class="btn btn-success"><i class="fa fa-plus"></i> Tambah Unit Kerja</a>
        </div>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td style="width:100px;text-align:center;">              
               ...
               <a title="Edit" class="update btn btn-sm btn-success" href="<?php echo base_url('admin/unit/edit/' . $row['id']); ?>"> <i class="fa fa-pencil-square-o"></i></a> 
