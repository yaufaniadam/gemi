...
<ul class="nav nav-tabs">
  <li role="presentation" <?php if ($url_sub_maqasid == 'pengajian') {
                            echo 'class="active"';
                          } ?>><a href="<?php echo base_url('admin/unit/lihat_unit/' . $current_kantor . "/" . $current_unit . "/pengajian"); ?>">
      <h4>Hifdz Ad-Din</h4>
      <p>Pengajian</p>
    </a></li>
  <li role="presentation" <?php if ($url_sub_maqasid == 'rekrutmen') {
                            echo 'class="active"';
                          } ?>><a href="<?php echo base_url('admin/unit/lihat_unit/' . $current_kantor . "/" . $current_unit . "/rekrutmen"); ?>">
      <h4>Hifdz An-Nafs</h4>
      <p>Rekrutmen</p>
    </a></li>
  <li role="presentation" <?php if ($url_sub_maqasid == 'kinerja') {
                            echo 'class="active"';
                          } ?>><a href="<?php echo base_url('admin/unit/lihat_unit/' . $current_kantor . "/" . $current_unit . "/kinerja"); ?>">
      <h4>Hifdz An-Nafs</h4>
      <p>Manajemen kinerja</p>
    </a></li>
  <li role="presentation" <?php if ($url_sub_maqasid == 'employee_productivity') {
                            echo 'class="active"';
                          } ?>><a href="<?php echo base_url('admin/unit/lihat_unit/' . $current_kantor . "/" . $current_unit . "/employee_productivity"); ?>">
      <h4>Hifdz An-Nafs</h4>
      <p>Employee productivity</p>
    </a></li>

  <li role="presentation" <?php if ($url_sub_maqasid == 'training') {
                            echo 'class="active"';
                          } ?>><a href="<?php echo base_url('admin/unit/lihat_unit/' . $current_kantor . "/" . $current_unit . "/training"); ?>">
      <h4>Hifdz Al’Aql</h4>
      <p>Training</p>
    </a></li>

  <li role="presentation" <?php if ($url_sub_maqasid == 'gathering') {
                            echo 'class="active"';
                          } ?>><a href="<?php echo base_url('admin/unit/lihat_unit/' . $current_kantor . "/" . $current_unit . "/gathering"); ?>">
      <h4>Hifdz An-Nasl</h4>
      <p>Gathering</p>
    </a></li>

  <li role="presentation" <?php if ($url_sub_maqasid == 'gaji') {
                            echo 'class="active"';
                          } ?>><a href="<?php echo base_url('admin/unit/lihat_unit/' . $current_kantor . "/" . $current_unit . "/gaji"); ?>">
      <h4>Hifdz Al-Maal</h4>
      <p>Dokumen gaji</p>
    </a></li>
...
<?php if ($url_sub_maqasid == 'pengajian') { ?>
  <a href="<?php echo base_url("admin/unit/rekap_training/$kantors/$unit/$sub_maqasid"); ?>" class="btn btn-success btn-sm d-block"> <i class="fas fa-file-excel"></i> Export ke Excel</a><br><br>
