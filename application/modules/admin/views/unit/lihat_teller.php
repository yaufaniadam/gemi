...
<ul class="nav nav-tabs">
  ...
  <li role="presentation" <?php if($sub_maqasid == 'kecepatan') { echo 'class="active"'; } ?>><a href="<?php echo base_url('admin/unit/lihat_unit/'. $current_kantor . "/".$current_unit."/kecepatan" ); ?>">
