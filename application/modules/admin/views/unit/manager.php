...
<h4>Funding </h4>
<hr>
<?php echo form_open_multipart(base_url('admin/unit/add_manager/'.$current_kantor ."/" . $current_unit."/mal"), 'class="form-horizontal"' )?> 
...
<h4>Lending</h4>
<hr>
<?php echo form_open_multipart(base_url('admin/unit/add_manager/'.$current_kantor ."/" . $current_unit."/din"), 'class="form-horizontal"' )?> 
