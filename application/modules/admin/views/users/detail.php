  			...
  			<div class="box box-primary">
  				...
  				<div class="box-body" style="padding-top:0">
  					...
  					<ul class="list-group list-group-unbordered">
  						...
  						<?php  } else { ?>
  						<li class="list-group-item"><b><?= $keluarga['nama_keluarga'] ?></b> <a
  								class="pull-right">Anak
  				...
  				<div class="box-body" style="padding-top:0">
  					...
  					<table class="table table-striped table-bordered">
  						...
  						<tr>
  							...
  							<td><a target="_blank" href="<?= base_url($row['file_sk_penempatan']); ?>">Unduh SK</a>
  							</td>
  						</tr>
