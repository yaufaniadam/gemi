  ...
  <div class="row">
    <div class="col-md-12">
      <div class="box box-body with-border">
        <div class="col-md-6">
          <h4><i class="fa fa-plus"></i> &nbsp; Tambah SK Baru</h4>
        </div>
        <div class="col-md-6 text-right">
          <a href="<?= base_url('admin/users/penempatan'); ?>" class="btn btn-success"><i class="fa fa-list"></i> Semua SK</a>
        </div>
      </div>
    </div>
  </div>
      ...
      <div class="box">
        ...
        <div class="box-body my-form-body">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open_multipart(base_url('admin/users/tambah_penempatan'), 'class="form-horizontal"');  ?>
            <div class="form-group">
                <label for="id_unit" class="col-sm-3 control-label">Nomor SK Pegawai</label>
                <div class="col-sm-9">
                  <input type="text" name="no_sk_penempatan" class="form-control" value="<?php if(validation_errors()) {echo set_value('no_sk_penempatan');  }  ?>">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select name="user_id" class="form-control">
                    <option value="">Pilih Pegawai  <?php !form_error('user_id') ? $val = set_value('user_id'): $val='' ; ?></option>
                    <?php foreach ( $staf as $staf) { ?>                      
                      <option value="<?php echo $staf['id']; ?>" <?php echo ($val == $staf['id'] ) ? "selected=true": ""; ?>><?php echo $staf['firstname']; ?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select name="id_kantor" class="form-control">
                    <option value="">Pilih Kantor <?php !form_error('id_kantor') ? $val = set_value('id_kantor'): $val='' ; ?></option>
                    <?php foreach ( $kantor as $kantor) { ?>                      
                      <option value="<?php echo $kantor['id']; ?>" <?php echo ($val == $kantor['id'] ) ? "selected=true": ""; ?>><?php echo $kantor['kantor']; ?></option>
                    <?php } ?>
                  </select>
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select name="id_unit" class="form-control">
                    <option value="">Pilih Unit Kerja <?php !form_error('id_unit') ? $val = set_value('id_unit'): $val='' ; ?></option>
                    <?php foreach($unit_kerja as $unit_kerja): ?>
                      <option value="<?= $unit_kerja['id']; ?>" <?php echo ($val == $unit_kerja['id'] ) ? "selected=true": ""; ?>><?= $unit_kerja['nama_unit'];  ?></option>
                    <?php endforeach; ?>
                  </select>
                </div>
              </div> 
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select name="keterangan" class="form-control">
                    <option value="">Pilih Keterangan <?php !form_error('keterangan') ? $val = set_value('keterangan'): $val='' ; ?></option>
                    <?php foreach($ket_penempatan as $ket_penempatan): ?>
                      <option value="<?= $ket_penempatan['id']; ?>" <?php echo ($val == $ket_penempatan['id'] ) ? "selected=true": ""; ?>><?= $ket_penempatan['keterangan'];  ?></option>
                    <?php endforeach; ?>
                  </select>
                </div>
              </div> 
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select name="jabatan" class="form-control">
                    <option value="">Pilih Jabatan <?php !form_error('jabatan') ? $val = set_value('jabatan'): $val='' ; ?></option>                   
                      <option value="pegawai" <?php echo ($val == 'pegawai' ) ? "selected=true": ""; ?>>Pegawai</option>                    
                      <option value="manager" <?php echo ($val == 'manager' ) ? "selected=true": ""; ?>>Manager</option>                    
                  </select>
                </div>
              </div> 
