...
<aside class="main-sidebar">
	...
	<section class="sidebar">
		<center><img style="padding:10px 10px 10px 0;" width="130" height="" class="img-profile" src="<?= base_url() ?>public/dist/img/logobmt.png" alt="SISKIMAS BMT"></center>
		...
		<ul class="sidebar-menu">
			...
			<li id="rekap">
				<a href="#">
					<i class="fa fa-gears"></i> <span>Rekap Kinerja Individu</span>
		...
		<ul class="sidebar-menu">
			...
			<li id="pengguna" class="treeview">
				...
				<ul class="treeview-menu">
					...
					<li class="submenu_pengguna" id=""><a href="<?= base_url('admin/users'); ?>"><i class="fa fa-circle-o"></i>Semua Pegawai</a></li>
					<li class="submenu_useradd"><a href="<?= base_url('admin/users/add'); ?>"><i class="fa fa-circle-o"></i>Tambah
							Pegawai</a></li>
					<li class="submenu_penempatan"><a href="<?= base_url('admin/users/penempatan'); ?>"><i class="fa fa-circle-o"></i>SK Pegawai</a></li>
